...
export default function Login() {
  ...
  return (
    <div className="min-h-screen pt-20 flex items-center justify-center px-4" style={{ background: 'var(--bg-base)', color: 'var(--text-primary)' }}>
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="font-display text-5xl tracking-widest mb-2">CONNEXION</h1>
        ...
        <form onSubmit={handleSubmit} className="card p-6 space-y-4">
          ...
          <p className="text-center text-secondary text-sm pt-2">
            ...
            <Link to={`/register?redirect=${encodeURIComponent(redirect)}`} className="font-bold hover:underline" style={{ color: 'var(--accent)' }}>
              S'inscrire
            </Link>
          </p>
        </form>
